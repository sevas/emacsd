...
;;;;
;;;; Name: DARKROOM Mode (writing)
;;;; Usage: M-x darkroom-mode
;;;; License: free for all usages/modifications/distributions/whatever.
;;;; Requirements: see martin-w32-fullscreen.el

(require 'cl)

(require 'martin-w32-fullscreen)
(require 'martin-frame-local-vars)
